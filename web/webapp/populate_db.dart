...
main(){
  ...
  objectory.initDomainModel().then((_) {
    ...
    var saveResults = [];
    for (var recipeMap in recipes) {
     Recipe recipe = new Recipe()
       ..name = recipeMap['name']
       ..rating = recipeMap['rating']
       ..category = recipeMap['category']
       ..directions = recipeMap['directions']
       ..imgUrl = recipeMap['imgUrl']
       ..ingredients = recipeMap['ingredients'];
     saveResults.add(recipe.save());
    }
    return Future.wait(saveResults);
  }).then((lst) {
    print('>> ${lst.length} recipes added to $Uri');
    var categories = new Categories();
    categories.list = categoryData;
    print('>> ${categories.list.length} categories added to $Uri');
